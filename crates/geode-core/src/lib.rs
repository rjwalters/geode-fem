...
pub use waveguide_modes::{
    ...
    disk_tri_mesh_pml_graded_checked, epsilon_r_from_region_tags, n_dof_2d_nedelec2,
    pml_stretch_tensor_2d, rect_pec_interior_dofs2, rect_pec_interior_edges,
    ...
    tri_nedelec2_local, tri_nedelec_local, worst_aspect_ratio, DielectricMode, DielectricModePml,
    ModeFieldShape, RadialGrading, TriMesh, WaveguideModeProfile, WaveguideSolveOpts,
    ASPECT_RATIO_SLIVER_BOUND, REGION_CLADDING, REGION_CORE, REGION_PML, TRI_LOCAL_EDGES,
};
