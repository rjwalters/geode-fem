---
name: anvil-primer-reviser
description: Anvil Primer Reviser - Dedicated subagent that executes the `anvil:primer-revise` lifecycle command. Use when running the revise phase of the primer skill, including parallel fan-out.
