...
Placeholder figure script for pub-figures (transmon-benchmark.2).

Data (COMMITTED: benchmarks/transmon_eigen/results.toml
[tripwires.junction_l_doubling] — base_f_ghz 17.4901, doubled_f_ghz 12.37,
ratio 0.7071 = 1/sqrt(2); test
crates/geode-core/tests/transmon_eigenmode.rs::tripwire_real_junction_l_doubling):
  - baseline: L = 14.860 nH -> junction mode 17.4901 GHz
...
_STYLE = REPO / ".anvil" / "anvil" / "lib" / "figures" / "anvil.mplstyle"
if _STYLE.exists():
