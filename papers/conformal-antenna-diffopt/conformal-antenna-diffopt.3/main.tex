%% main.tex — Anvil paper (thread: conformal-antenna-diffopt, version .3)
%% Cosmetic-polish pass by anvil:paper-revise from .2 against the .2.review +
%% .2.audit critic siblings: caption-placeholder strip, "intractable" scoping,
%% headline-number de-duplication. No number, claim, method, or citation changed.
