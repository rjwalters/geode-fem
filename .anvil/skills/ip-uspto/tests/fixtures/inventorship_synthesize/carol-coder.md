...
**Vendored paths on this filing you are associated with:**
- `third_party/codec/decode.c`
...
- `eeeeeeeeee (2026-03-11T10:00:00Z) [implementation] import vendored codec — path: third_party/codec/decode.c`
...
Name (typed): _____________________________________  (Carol Coder)
