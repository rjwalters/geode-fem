"""Back-compat shim (issue #382): canonical module is ``anvil/lib/cross_thread_refs.py``.
...
(``anvil.skills.memo.lib.cross_thread_refs``) so existing memo
consumers and tests keep working unchanged.
"""

from anvil.lib.cross_thread_refs import *  # noqa: F401,F403
